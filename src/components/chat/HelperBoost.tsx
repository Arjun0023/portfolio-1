...
const questionConfig = [
  ...
  { key: 'Experience', color: '#E67E22', icon: BriefcaseIcon },
    ...
    <>
      <Drawer.Root open={open} onOpenChange={setOpen}>
        <div className="w-full">
          ...
          >
            <button
              ...
              className="flex items-center gap-1 px-3 py-1 text-xs text-gray-500 dark:text-gray-400 transition-colors hover:text-gray-700 dark:hover:text-gray-300"
            >
              {isVisible ? (
                <>
                  <ChevronDown size={14} />
        ...
        <Drawer.Portal>
          ...
          <Drawer.Content className="fixed right-0 bottom-0 left-0 z-100 mt-24 flex h-[80%] flex-col rounded-t-[10px] bg-gray-100 dark:bg-black outline-none lg:h-[60%]">
            <div className="flex-1 overflow-y-auto rounded-t-[10px] bg-white dark:bg-black p-4">
              <div className="mx-auto max-w-md space-y-4">
                <div
                  aria-hidden
                  className="mx-auto mb-8 h-1.5 w-12 flex-shrink-0 rounded-full bg-gray-300 dark:bg-gray-600"
                />
  ...
  return (
    <motion.button
      className={cn(
        ...
        isSpecial ? 'bg-black dark:bg-white dark:text-black' : 'bg-[#F7F8F9] dark:bg-gray-800'
      )}
      onClick={onClick}
