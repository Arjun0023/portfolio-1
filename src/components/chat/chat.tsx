...
const Chat = () => {
  ...
  const {
    ...
    onError: (error) => {
      ...
      if (error.message?.includes('quota') || error.message?.includes('exceeded') || error.message?.includes('429')) {
        ...
        toast.error('⚠️ API Quota Exhausted! Free Gemini API limit reached. Please contact Arjun directly or use preset questions. Thank you for understanding! 🙏', {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div
        className="fixed top-0 right-0 left-0 z-50 bg-gradient-to-b from-white via-white/80 to-transparent dark:from-black dark:via-black/80 dark:to-transparent"
      >
        <div
      ...
      <div className="container mx-auto flex h-full max-w-3xl flex-col">
        ...
        {/* Fixed Bottom Bar */}
        <div className="sticky bottom-0 bg-white dark:bg-black px-2 pt-3 md:px-0 md:pb-4">
